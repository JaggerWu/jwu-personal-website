...
%%% Essentials
\name{Jian}{Wu}
\address{Gulkløvervænget 12, 2625 Vallensbæk, Denmark}
\mobile{(+45) 31-90-02-54} 
%%% Social
\email{xcb479@alumni.ku.dk}
\homepage{www.jaggerwu.com}
\github{JaggerWu}
\linkedin{Jian Wu}
%%% Optionals
\position{Software developer{\enskip\cdotp\enskip}Master Student}
